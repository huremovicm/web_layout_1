...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#parBg">Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  ...
  <div class="jumbotron jumbotron-fluid" id="mainPlace">
    ...
    <div class="container container-custom">
      ...
      <h1 class="display-4" id="mainTitle">Travel agency</h1>

      <p class="lead" id="titleDesc">Adventure Awaits, Go Find It.</p>
    </div>
  </div>
  ...
  <div class="container text-center">
    ...
    <div class="row">
      <div class="col-lg">
        <img class="img-fluid" src="images/ex.jpg" alt="example">
        <figcaption>
          <h6>Sea</h6>
        </figcaption>
      </div>
      ...
      <div class="col-lg">
        <img class="img-fluid" src="images/ex1.jpg" alt="example1">
        <figcaption>
          <h6>Mountain</h6>
        </figcaption>
      </div>
      <div class="col-lg">
        <img class="img-fluid" src="images/ex2.jpg" alt="example2">
        <figcaption>
          <h6>Desert</h6>
        </figcaption>
      </div>
  ...
  <div class="container text-center">
    <div class="row">
      <div class="col-lg">
        <img class="img-fluid" src="images/plane.jpg" alt="example2">
        <figcaption>
          <h6>Airplane</h6>
        </figcaption>
      </div>
      <div class="col-lg">
        <img class="img-fluid" src="images/boat.jpg" alt="example2">
        <figcaption>
          <h6>Boat</h6>
        </figcaption>
      </div>
